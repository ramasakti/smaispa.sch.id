...
<head>
    ...
    <!-- ======= Styles =======-->
    <link href="/nova/assets/vendors/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="/nova/assets/vendors/bootstrap-icons/font/bootstrap-icons.min.css" rel="stylesheet">
    <link href="/nova/assets/vendors/glightbox/glightbox.min.css" rel="stylesheet">
    <link href="/nova/assets/vendors/swiper/swiper-bundle.min.css" rel="stylesheet">
    <link href="/nova/assets/vendors/aos/aos.css" rel="stylesheet">
    <!-- End Styles-->

    <!-- ======= Theme Style =======-->
    <link href="/nova/assets/css/style.css" rel="stylesheet">
    <!-- End Theme Style-->
...
<body>
        ...
        <header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <a class="navbar-brand w-auto" href="index.html">
                    ...
                    <!-- logo dark--><img class="logo dark img-fluid" src="/nova/assets/images/logo-dark.svg"
                        alt="FreeBootstrap.net image placeholder">

                    <!-- logo light--><img class="logo light img-fluid" src="/nova/assets/images/logo-light.svg"
                        alt="FreeBootstrap.net image placeholder">
                ...
                <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1"
                        ...
                        <div class="offcanvas-header-logo">
                            ...
                            <a class="logo-link" id="fbs__net-navbarsLabel" href="index.html">
                                ...
                                <!-- logo dark--><img class="logo dark img-fluid"
                                    src="/nova/assets/images/logo-dark.svg" alt="FreeBootstrap.net image placeholder">
                    ...
                    <div class="offcanvas-body align-items-lg-center">
                        ...
                        <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link scroll-link active" aria-current="page" href="#home">
                                    Home
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item dropstart">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="nav-link scroll-link dropdown-item" href="#pricing">
                                                    Pricing
                                                </a>
                                            </li>
                                            <li class="nav-item dropstart">
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    ...
                                    <div class="cta d-flex gap-2 mb-4 mb-lg-5" data-aos="fade-up"
                                        data-aos-delay="300">
                                        <a class="btn" href="https://wa.me/62851517229291">WhatsApp</a>
                        ...
                        <div class="col-lg-6">
                            <div class="hero-img"><img class="img-card img-fluid"
                                    src="/nova/assets/images/card-expenses.png" alt="Image card" data-aos="fade-down"
                                    data-aos-delay="600"><img class="img-main img-fluid rounded-4"
                                    src="/nova/assets/images/hero-img-1-min.jpg" alt="Hero Image" data-aos="fade-in"
                    ...
                    <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
                            ...
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="/nova/assets/images/person-sq-2-min.jpg"
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="/nova/assets/images/person-sq-1-min.jpg"
                                            alt="FreeBootstrap.net image placeholder"></div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="/nova/assets/images/person-sq-5-min.jpg"
                                            alt="FreeBootstrap.net image placeholder"></div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="/nova/assets/images/person-sq-3-min.jpg"
                                            alt="FreeBootstrap.net image placeholder"></div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="/nova/assets/images/person-sq-7-min.jpg"
                                            alt="FreeBootstrap.net image placeholder"></div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="/nova/assets/images/person-sq-8-min.jpg"
                                            alt="FreeBootstrap.net image placeholder"></div>
    ...
    <!-- ======= Javascripts =======-->
    <script src="/nova/assets/vendors/bootstrap/bootstrap.bundle.min.js"></script>
    <script src="/nova/assets/vendors/gsap/gsap.min.js"></script>
    <script src="/nova/assets/vendors/imagesloaded/imagesloaded.pkgd.min.js"></script>
    <script src="/nova/assets/vendors/isotope/isotope.pkgd.min.js"></script>
    <script src="/nova/assets/vendors/glightbox/glightbox.min.js"></script>
    <script src="/nova/assets/vendors/swiper/swiper-bundle.min.js"></script>
    <script src="/nova/assets/vendors/aos/aos.js"></script>
    <script src="/nova/assets/vendors/purecounter/purecounter.js"></script>
    <script src="/nova/assets/js/custom.js"></script>
    <script src="/nova/assets/js/send_email.js"></script>
    <!-- End JavaScripts-->
</body>
